...
const datum = Data.to<Datum>(
  {
    lock_until: 1699222000000n, // Wed Jan 04 2023 14:52:41 GMT+0000
...
const txLock = await lock(2000000n, { into: validator, datum: datum });

await lucid.awaitTx(txLock);
   
console.log(`2 tADA locked into the contract at:
  Tx ID: ${txLock}
  Datum: ${datum}
`);
...
async function lock(
    lovelace: bigint,
    { into, datum }: { into: SpendingValidator; datum: Datum }
  ): Promise<TxHash> {
